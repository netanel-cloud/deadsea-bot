/**
 * Dead Sea Rider ג€” Floating Chat Widget
 * ׳×׳™׳™׳¨׳•׳× ׳™׳ ׳”׳׳׳— ג€” ׳•׳™׳“׳’'׳˜ ׳¦'׳׳˜ ׳¦׳£
 *
 * ׳©׳™׳׳•׳© (׳‘׳׳×׳¨ ׳©׳׳›׳):
 ...
 *       apiUrl: 'https://your-bot-server.com/chat',  // ׳”-API endpoint ׳©׳ ׳”׳©׳¨׳×
 *       position: 'left',   // 'left' ׳׳• 'right' (׳‘׳¨׳™׳¨׳× ׳׳—׳“׳: left ׳-RTL)
 *       primaryColor: '#0D7A8E',
...
(function() {
  ...
  const css = `
    ...
    #ds-bot-panel .ds-status::before { content: 'ג—'; color: #4ade80; margin-left: 4px; font-size: 9px; vertical-align: middle; }
  ...
  // ג”€ג”€ HTML ׳©׳ ׳”-widget ג”€ג”€
  const html = `
    <button id="ds-bot-launcher" aria-label="׳₪׳×׳— ׳¦'׳׳˜">
      <span id="ds-bot-pulse"></span>
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
      </svg>
    </button>
    <div id="ds-bot-panel" role="dialog" aria-label="׳¦'׳׳˜ ׳×׳™׳™׳¨׳•׳× ׳™׳ ׳”׳׳׳—">
      <div class="ds-header">
        <div class="ds-avatar">נ</div>
        <div>
          <div class="ds-name">${escapeHtml(config.botName)}</div>
          <div class="ds-status">׳׳—׳•׳‘׳¨ ׳¢׳›׳©׳™׳•</div>
        </div>
        <button class="ds-close" aria-label="׳¡׳’׳•׳¨">ֳ—</button>
      </div>
      ...
      <div class="ds-input-bar">
        <input class="ds-input" id="ds-inp" placeholder="׳©׳׳ ׳׳•׳×׳™ ׳›׳ ׳“׳‘׳¨..." dir="rtl">
        <button class="ds-send" id="ds-send" aria-label="׳©׳׳—">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
            <path d="M22 2L11 13"/><path d="M22 2L15 22 11 13 2 9l20-7z"/>
          </svg>
        </button>
      </div>
      <div class="ds-note">׳×׳™׳™׳¨׳•׳× ׳™׳ ׳”׳׳׳— ֲ· ׳”׳–׳׳ ׳•׳× ׳“׳¨׳ deadsea.fun</div>
    </div>
  `;
  ...
  function addBotMsg(html) {
    ...
    row.innerHTML = `<div class="ds-icon bot">נ</div><div class="ds-bubble bot">${html}</div>`;
  ...
  function addUserMsg(text) {
    ...
    row.innerHTML = `<div class="ds-icon user">נ‘₪</div><div class="ds-bubble user">${escapeHtml(text)}</div>`;
    msgs.appendChild(row);
    msgs.scrollTop = msgs.scrollHeight;
  }
  ...
  function showTyping() {
    ...
    row.innerHTML = `<div class="ds-icon bot">נ</div><div class="ds-typing"><span></span><span></span><span></span></div>`;
    msgs.appendChild(row);
    msgs.scrollTop = msgs.scrollHeight;
  }
  ...
  function formatResponse(text) {
    ...
    text = text.replace(/https:\/\/deadsea\.fun\/?/g,
      `<br><a class="ds-book-cta" href="https://deadsea.fun/" target="_blank">נ“… ׳”׳–׳׳™׳ ׳• ׳‘-deadsea.fun</a>`);
    text = text.replace(/054-?331-?6613/g,
      `<a class="ds-wa-cta" href="https://wa.me/${config.waNumber}" target="_blank">נ’¬ 054-331-6613</a>`);
    text = text.replace(/\n/g, '<br>');
    return text;
  }
  ...
  async function sendMessageText(text) {
    ...
    try {
      ...
      removeTyping();
      addBotMsg(`׳׳¦׳˜׳¢׳¨, ׳”׳™׳™׳×׳” ׳‘׳¢׳™׳” ׳˜׳›׳ ׳™׳× ׳¨׳’׳¢׳™׳× נ˜”<br><br>׳׳₪׳©׳¨ ׳׳₪׳ ׳•׳× ׳׳׳™׳ ׳• ׳™׳©׳™׳¨׳•׳×:<br><a class="ds-wa-cta" href="https://wa.me/${config.waNumber}" target="_blank">נ’¬ 054-331-6613 ׳‘׳•׳•׳˜׳¡׳׳₪</a>`);
    } finally {
